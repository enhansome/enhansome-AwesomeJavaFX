...
* [Hello Minecraft! Launcher](https://github.com/huanghongxun/HMCL) ⭐ 9,870 | 🐛 515 | 🌐 Java | 📅 2026-08-19 - HMCL (Hello Minecraft! Launcher) is a cross-platform Minecraft launcher which supports Mod management, game customizing, auto installing (Forge, LiteLoader and OptiFine), modpack creating, UI customizing and so on. HMCL was developed based on Swing and migrated to JavaFX in v3.
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,339 | 🐛 67 | 🌐 Java | 📅 2026-08-17 - An easy to use modern Java bytecode editor.
