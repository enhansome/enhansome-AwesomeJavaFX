...
* [AtlantaFX](https://github.com/mkpaz/atlantafx) ⭐ 1,416 | 🐛 16 | 🌐 Java | 📅 2026-08-23 - Modern JavaFX CSS theme collection with additional controls.
...
* [CalendarFX](https://github.com/dlemmermann/CalendarFX) ⭐ 860 | 🐛 21 | 🌐 Java | 📅 2026-09-18 - CalendarFX is a calendar framework for JavaFX 8. It contains a set of professional custom controls, which can be used to implement a calendar UI for any kind of application.
...
* [graph editor](https://github.com/eckig/graph-editor) ⭐ 201 | 🐛 0 | 🌐 Java | 📅 2026-09-16 - A library for creating and editing graph-like diagrams in JavaFX.
...
* [TabShell](https://github.com/techsenger/tabshell) ⭐ 41 | 🐛 0 | 🌐 Java | 📅 2026-09-20 - TabShell is a platform for building tab-based applications in JavaFX, where an application is structured as a tree of MVP components. The platform provides classes for creating components, as well as ready-to-use dialogs, layouts, and devtools.
...
* [Hello Minecraft! Launcher](https://github.com/huanghongxun/HMCL) ⭐ 10,094 | 🐛 478 | 🌐 Java | 📅 2026-09-20 - HMCL (Hello Minecraft! Launcher) is a cross-platform Minecraft launcher which supports Mod management, game customizing, auto installing (Forge, LiteLoader and OptiFine), modpack creating, UI customizing and so on. HMCL was developed based on Swing and migrated to JavaFX in v3.
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,391 | 🐛 64 | 🌐 Java | 📅 2026-09-15 - An easy to use modern Java bytecode editor.
...
* [PacManFX](https://github.com/armin-reichert/pacman-javafx) ⭐ 122 | 🐛 5 | 🌐 Java | 📅 2026-09-20 - A JavaFX UI (2D + 3D) for Pac-Man and Ms. Pac-Man.
