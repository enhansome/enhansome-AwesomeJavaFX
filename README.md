...
* [QuPath](https://github.com/qupath/qupath) ⭐ 1,432 | 🐛 31 | 🌐 Java | 📅 2026-09-01 - Open source software for bioimage analysis.
* [AtlantaFX](https://github.com/mkpaz/atlantafx) ⭐ 1,398 | 🐛 16 | 🌐 Java | 📅 2026-08-23 - Modern JavaFX CSS theme collection with additional controls.
...
* [GemsFX](https://github.com/dlsc-software-consulting-gmbh/GemsFX) ⭐ 620 | 🐛 1 | 🌐 Java | 📅 2026-08-27 - A small library with useful controls: an on-screen keyboard, a PDF viewer control, and some more.
...
* [graph editor](https://github.com/eckig/graph-editor) ⭐ 201 | 🐛 0 | 🌐 Java | 📅 2026-08-28 - A library for creating and editing graph-like diagrams in JavaFX.
...
* [TabShell](https://github.com/techsenger/tabshell) ⭐ 35 | 🐛 0 | 🌐 Java | 📅 2026-08-31 - TabShell is a platform for building tab-based applications in JavaFX, where an application is structured as a tree of MVP components. The platform provides classes for creating components, as well as ready-to-use dialogs, layouts, and devtools.
...
* [Hello Minecraft! Launcher](https://github.com/huanghongxun/HMCL) ⭐ 9,972 | 🐛 527 | 🌐 Java | 📅 2026-09-01 - HMCL (Hello Minecraft! Launcher) is a cross-platform Minecraft launcher which supports Mod management, game customizing, auto installing (Forge, LiteLoader and OptiFine), modpack creating, UI customizing and so on. HMCL was developed based on Swing and migrated to JavaFX in v3.
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,365 | 🐛 66 | 🌐 Java | 📅 2026-08-22 - An easy to use modern Java bytecode editor.
...
* [FXDesktopSearch](https://github.com/mirkosertic/FXDesktopSearch) ⭐ 185 | 🐛 15 | 🌐 Java | 📅 2026-08-31 - FXDesktopSearch is a Java and JavaFX based Desktop Search Application. It crawls a configured set of directories and allows you to do fulltext search with different languages support on the content.
* [PacManFX](https://github.com/armin-reichert/pacman-javafx) ⭐ 121 | 🐛 5 | 🌐 Java | 📅 2026-09-01 - A JavaFX UI (2D + 3D) for Pac-Man and Ms. Pac-Man.
