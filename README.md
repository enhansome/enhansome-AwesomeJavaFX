...
* [QuPath](https://github.com/qupath/qupath) ⭐ 1,445 | 🐛 35 | 🌐 Java | 📅 2026-09-16 - Open source software for bioimage analysis.
...
* [AtlantaFX](https://github.com/mkpaz/atlantafx) ⭐ 1,417 | 🐛 17 | 🌐 Java | 📅 2026-09-21 - Modern JavaFX CSS theme collection with additional controls.
...
* [graph editor](https://github.com/eckig/graph-editor) ⭐ 201 | 🐛 2 | 🌐 Java | 📅 2026-09-21 - A library for creating and editing graph-like diagrams in JavaFX.
...
* [TabShell](https://github.com/techsenger/tabshell) ⭐ 41 | 🐛 0 | 🌐 Java | 📅 2026-09-21 - TabShell is a platform for building tab-based applications in JavaFX, where an application is structured as a tree of MVP components. The platform provides classes for creating components, as well as ready-to-use dialogs, layouts, and devtools.
...
* [Hello Minecraft! Launcher](https://github.com/huanghongxun/HMCL) ⭐ 10,100 | 🐛 480 | 🌐 Java | 📅 2026-09-20 - HMCL (Hello Minecraft! Launcher) is a cross-platform Minecraft launcher which supports Mod management, game customizing, auto installing (Forge, LiteLoader and OptiFine), modpack creating, UI customizing and so on. HMCL was developed based on Swing and migrated to JavaFX in v3.
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,393 | 🐛 64 | 🌐 Java | 📅 2026-09-15 - An easy to use modern Java bytecode editor.
...
* [FX2048](https://github.com/brunoborges/fx2048) ⭐ 294 | 🐛 3 | 🌐 Java | 📅 2026-09-19 - The game 2048 built using JavaFX and Java 11.
...
* [PacManFX](https://github.com/armin-reichert/pacman-javafx) ⭐ 122 | 🐛 5 | 🌐 Java | 📅 2026-09-21 - A JavaFX UI (2D + 3D) for Pac-Man and Ms. Pac-Man.
