...
* [QuPath](https://github.com/qupath/qupath) ⭐ 1,447 | 🐛 36 | 🌐 Java | 📅 2026-09-16 - Open source software for bioimage analysis.
...
* [AtlantaFX](https://github.com/mkpaz/atlantafx) ⭐ 1,422 | 🐛 15 | 🌐 Java | 📅 2026-09-22 - Modern JavaFX CSS theme collection with additional controls.
...
* [CalendarFX](https://github.com/dlemmermann/CalendarFX) ⭐ 861 | 🐛 21 | 🌐 Java | 📅 2026-09-18 - CalendarFX is a calendar framework for JavaFX 8. It contains a set of professional custom controls, which can be used to implement a calendar UI for any kind of application.
...
* [GemsFX](https://github.com/dlsc-software-consulting-gmbh/GemsFX) ⭐ 622 | 🐛 0 | 🌐 Java | 📅 2026-09-21 - A small library with useful controls: an on-screen keyboard, a PDF viewer control, and some more.
...
* [graph editor](https://github.com/eckig/graph-editor) ⭐ 201 | 🐛 3 | 🌐 Java | 📅 2026-09-22 - A library for creating and editing graph-like diagrams in JavaFX.
...
* [FXTaskbarProgressBar](https://github.com/Dansoftowner/FXTaskbarProgressBar) ⭐ 98 | 🐛 3 | 🌐 Java | 📅 2021-08-23 - A library for showing progress on the Windows taskbar.
...
* [mvciFX](https://github.com/barmat80/mvciFX) ⭐ 6 | 🐛 0 | 🌐 Java | 📅 2025-05-17 - a Java implementation of the MVCI framework by Dave Barrett, aka PragmaticCoding.
* [SuggesterFX](https://github.com/barmat80/SuggesterFX) ⭐ 6 | 🐛 0 | 🌐 Java | 📅 2025-05-17 -  a JavaFX lightweight library that provides a suggestion (autocompletion) system for text fields linked to data entries. This library integrates with mvciFX library to provide a clean, maintainable architecture for handling suggestions and autocompletion.
...
* [TabShell](https://github.com/techsenger/tabshell) ⭐ 41 | 🐛 0 | 🌐 Java | 📅 2026-09-22 - TabShell is a platform for building tab-based applications in JavaFX, where an application is structured as a tree of MVP components. The platform provides classes for creating components, as well as ready-to-use dialogs, layouts, and devtools.
...
* [Hello Minecraft! Launcher](https://github.com/huanghongxun/HMCL) ⭐ 10,105 | 🐛 479 | 🌐 Java | 📅 2026-09-22 - HMCL (Hello Minecraft! Launcher) is a cross-platform Minecraft launcher which supports Mod management, game customizing, auto installing (Forge, LiteLoader and OptiFine), modpack creating, UI customizing and so on. HMCL was developed based on Swing and migrated to JavaFX in v3.
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,392 | 🐛 64 | 🌐 Java | 📅 2026-09-15 - An easy to use modern Java bytecode editor.
...
* [FX2048](https://github.com/brunoborges/fx2048) ⭐ 294 | 🐛 4 | 🌐 Java | 📅 2026-09-23 - The game 2048 built using JavaFX and Java 11.
* [Mindolph](https://github.com/mindolph/Mindolph) ⭐ 200 | 🐛 5 | 🌐 Java | 📅 2026-09-13 - Mindolph is an open source personal knowledge management software for all desktop platforms. It is also a mind map editor, which is probably the best mind map tool developed by JavaFX.
...
* [PacManFX](https://github.com/armin-reichert/pacman-javafx) ⭐ 122 | 🐛 5 | 🌐 Java | 📅 2026-09-22 - A JavaFX UI (2D + 3D) for Pac-Man and Ms. Pac-Man.
