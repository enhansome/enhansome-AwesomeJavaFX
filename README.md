...
* [QuPath](https://github.com/qupath/qupath) ⭐ 1,435 | 🐛 32 | 🌐 Java | 📅 2026-09-01 - Open source software for bioimage analysis.
...
* [TabShell](https://github.com/techsenger/tabshell) ⭐ 36 | 🐛 0 | 🌐 Java | 📅 2026-09-04 - TabShell is a platform for building tab-based applications in JavaFX, where an application is structured as a tree of MVP components. The platform provides classes for creating components, as well as ready-to-use dialogs, layouts, and devtools.
...
* [Hello Minecraft! Launcher](https://github.com/huanghongxun/HMCL) ⭐ 10,002 | 🐛 510 | 🌐 Java | 📅 2026-09-05 - HMCL (Hello Minecraft! Launcher) is a cross-platform Minecraft launcher which supports Mod management, game customizing, auto installing (Forge, LiteLoader and OptiFine), modpack creating, UI customizing and so on. HMCL was developed based on Swing and migrated to JavaFX in v3.
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,373 | 🐛 66 | 🌐 Java | 📅 2026-08-22 - An easy to use modern Java bytecode editor.
...
* [PacManFX](https://github.com/armin-reichert/pacman-javafx) ⭐ 121 | 🐛 5 | 🌐 Java | 📅 2026-09-05 - A JavaFX UI (2D + 3D) for Pac-Man and Ms. Pac-Man.
